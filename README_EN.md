...
Install ForestCode as a global terminal tool with uv:
...
```sh
uv tool install --force dist/forestcode-1.0.0-py3-none-any.whl
```
...
ForestCode is licensed under the [MIT License](LICENSE).
